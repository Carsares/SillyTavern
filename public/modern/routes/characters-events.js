export function createCharactersEvents(ctx) {
    const {
        state,
        render,
        showToast,
    ...
    async function handleCharactersClick(event) {
    ...
    function handleCharactersInput(event) {
    ...
    async function handleCharactersChange(event) {
